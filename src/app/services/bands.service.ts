...
export class BandsService {
  ...
  public bandsData = new BehaviorSubject<Band[]>([
    {id: 1, name: 'The Rolling Stones', country: 'England', members: [{id: Math.random(), instrument: 'Voice', name: 'Mick Jagger'}, {id: Math.random() , instrument: 'Guitar', name: 'Keith Richards'}], history: 'Excesos', video: 'url'},
